...
const seed = async () => {
    try {
        console.log('Starting DB Seed (JS Version)...');
        ...
        // Only insert if email doesn't exist (email IS unique)
        await pool.query(`
        ...
        for (const mat of materials) {
            ...
            if (catId) {
                ...
                if (check.rows.length === 0) {
                    await pool.query(
                        "INSERT INTO materials (category_id, material_name, physical_form, description, recyclable) VALUES ($1, $2, 'solid', $3, true)",
